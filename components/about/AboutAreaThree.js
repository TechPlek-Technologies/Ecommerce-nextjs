...
import about_1 from "@/public/img/about/about-1.png";
import about_2 from "@/public/img/about/about-2.png";
import about_3 from "@/public/img/about/about-3.png";

// about item
function AboutItem({ img, title }) {
  return (
...
const AboutAreaThree = ({style_2=false}) => {
  return (
