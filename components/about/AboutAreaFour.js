...
import about_inner from '@/public/img/banner/about-inner-bg.png';
            ...
            <div className="tpabout__inner-thumb-2 p-relative mb-30">
              ...
              {/* <div className="tpabout__inner-thumb-shape d-none d-md-block">
                <div className="tpabout__inner-thumb-shape-one" style={{ position: 'relative', width: '100px', height: '100px' }}>
                  <Image src={shape_1} alt="shape" style={{ objectFit: 'contain' }} />
                </div>
                <div className="tpabout__inner-thumb-shape-two" style={{ position: 'relative', width: '100px', height: '100px' }}>
                  <Image src={shape_2} alt="shape" style={{ objectFit: 'contain' }} />
                </div>
                ;
              </div> */}
            </div>
          ...
          <div className="col-lg-6">
            <div className="tpabout__inner-2 mb-30">
              ...
              <p>
                ...
                clients succeed by creating brand identities, digital experiences, and print materials. Sed <br /> trspiciatis unde omnis
                iste natus error sit voluptatem accusantium.
              </p>
              <div className="tpabout__inner-list">
                <ul>
                  <li>
                    <i className="icon-check"></i> Track your daily activity.
                  </li>
                  <li>
                    <i className="icon-check"></i> Start a private group video call.
                  </li>
                  <li>
                    <i className="icon-check"></i> All the lorem ipsum generators on the Internet.
                  </li>
                </ul>
              </div>
            </div>
